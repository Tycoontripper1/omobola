...
import { Calendar, DollarSign, FileText, Users, BookOpen, Shield, Bus, Utensils, Heart, Download } from "lucide-react"
  ...
  const policies = [
    {
      ...
      description: "Comprehensive safety protocols, secure campus, and emergency procedures.",
    },
    {
      icon: Users,
      title: "Code of Conduct",
      description: "Clear expectations for student behavior, respect, and academic integrity.",
    },
    {
      icon: Heart,
      title: "Anti-Bullying",
      description: "Zero-tolerance policy with prevention programs and support systems.",
    },
    {
      icon: BookOpen,
      title: "Academic Standards",
      description: "High expectations for learning, homework policies, and grading standards.",
    },
  ]
  ...
  const services = [
    {
      ...
      description: "Safe, reliable bus service covering major residential areas.",
      details: "Routes available throughout the city with GPS tracking and certified drivers.",
    },
    {
      icon: Utensils,
      title: "Nutrition Program",
      description: "Healthy, balanced meals prepared fresh daily in our kitchen.",
      details: "Breakfast and lunch programs with vegetarian and allergy-friendly options.",
    },
    {
      icon: Heart,
      title: "Health Services",
      description: "On-site nurse and health clinic for student wellness needs.",
      details: "First aid, medication management, and health screenings available.",
    },
    {
      icon: BookOpen,
      title: "Library & Resources",
      description: "Modern library with extensive digital and print collections.",
      details: "Research support, study spaces, and technology access for all students.",
    },
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-6 max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-balance leading-tight">
              Everything You Need to <span className="text-primary">Know</span> About Omobola School
            </h1>
            <p className="text-xl text-muted-foreground text-pretty leading-relaxed">
              Comprehensive information about admissions, policies, services, and everything that makes our school
              community special.
            </p>
          </div>
        </div>
          ...
          <Tabs defaultValue="admissions" className="w-full">
            ...
            <TabsContent value="tuition" className="space-y-12">
              <div className="text-center space-y-4 mb-12">
                ...
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                  Transparent pricing with financial aid options available for qualifying families.
                </p>
              </div>

              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="space-y-6">
                  <h3 className="text-2xl font-semibold">Annual Tuition (2024-2025)</h3>
                  <div className="space-y-4">
                    {tuitionFees.map((item, index) => (
                      <Card key={index}>
                        <CardHeader>
                          <CardTitle className="text-lg">{item.grade}</CardTitle>
                          <div className="flex justify-between items-center">
                            <span className="text-2xl font-bold text-primary">{item.tuition}</span>
                            <Badge variant="outline">+ {item.fees} fees</Badge>
                          </div>
                        </CardHeader>
                      </Card>
                    ))}
                ...
                <div className="space-y-6">
                  <Card className="border-2 border-secondary/20">
                    <CardHeader>
                      ...
                      <CardDescription>
                        We believe quality education should be accessible to all qualified students.
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
            ...
            <TabsContent value="policies" className="space-y-12">
              <div className="text-center space-y-4 mb-12">
                ...
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                  Clear guidelines that ensure a safe, respectful, and productive learning environment for all.
                </p>
              </div>
                ...
                {policies.map((policy, index) => (
                  <Card key={index} className="border-2 hover:border-primary/20 transition-colors">
                    <CardHeader>
                      ...
                      <CardDescription className="leading-relaxed">{policy.description}</CardDescription>
                    </CardHeader>
                  </Card>
                ))}
              </div>
              ...
              <Card className="bg-muted/30">
                <CardHeader>
                  ...
                  <CardDescription>Download complete policy handbooks and guidelines.</CardDescription>
                </CardHeader>
            ...
            <TabsContent value="services" className="space-y-12">
              <div className="text-center space-y-4 mb-12">
                ...
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                  Comprehensive support services to enhance the educational experience and student well-being.
                </p>
              </div>
